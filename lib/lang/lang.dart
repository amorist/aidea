mixin AppLocale {
  ...
  static const Map<String, dynamic> zh = {
    ...
    send: '发送',
    uploading: '上传中...',
    robotIsThinkingMessage: '智链正在思考中...',
    ...
    modelUsage: '模型用于设置采用的 AI 智链类型',
    promptUsage: '领域设定用于设置 AI 智链的行为',
    nameRequiredMessage: '请输入智链名称',
    ...
    promptHint: '设定该智链的角色和技能，以便为你提供更精准有效的信息。',
